...
/**
 * Constantes migradas de todo_config.php
...
define('BASEPATH'     , IS_LOCAL ? '/TODOFramework/' : '____EL BASEPATH EN PRODUCCIÓN___');
...
// multiples instancias de TODO para proyectos diferentes y los cookies no representen un problema por el nombre repetido
define('AUTH_TKN_NAME', 'todo__cookie_tkn');
define('AUTH_ID_NAME' , 'todo__cookie_id');

// Salt utilizada para agregar seguridad al hash de contraseñas o similar dependiendo el uso requerido
define('AUTH_SALT'    , 'TODOFramework');
