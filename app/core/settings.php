...
define('TODO_NAME'    , $this->framework); // Viene desde Bee.php
define('TODO_VERSION' , $this->version);   // Viene desde Bee.php
define('SITE_NAME'   , 'TODO Mining');    // Configurado desde Bee.php
