...
<div class="container">
  <div class="row">
    <div class="col-6 text-center offset-xl-3">
      ...
      <h5 class="text-center text-white">En alg&uacute;n tejido tiempo-espacio puede estar lo que buscas, pero aqu&iacute; no.</h5>
      <div class="mt-5">
        <a class="btn btn-success btn-lg" href="home"><i class="fas fa-undo"></i> Regresar</a>
      </div>
      <div class="mt-5">
        <p class="text-muted">Desarrollado por <a href="https://www.youtube.com/@TODOMining" class="text-white">TODO Mining</a>.</p>
      </div>
    </div>
  </div>
</div>
